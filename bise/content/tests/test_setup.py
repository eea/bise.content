...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.isProductInstalled("bise.content"))

    def test_browserlayer(self):
        """Test that IBiseContentLayer is registered."""
        from bise.content.interfaces import IBiseContentLayer
        from plone.browserlayer import utils

        self.assertIn(IBiseContentLayer, utils.registered_layers())
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.isProductInstalled("bise.content"))
    ...
    def test_browserlayer_removed(self):
        ...
        self.assertNotIn(IBiseContentLayer, utils.registered_layers())
